...
export default function ChooseUs() {
  return (
    <div className="flex flex-col justify-center items-center py-36 lg:gap-16 px-8 lg:px-40 lg:py-16 ">
      ...
      <div className="flex lg:flex-row lg:justify-start lg:items-start lg:text-start justify-center items-center text-center flex-col gap-24 lg:gap-52">
        <div className="flex flex-col gap-2 lg:justify-start lg:items-start items-center flex-wrap w-full lg:w-[100%]">
          ...
          <button className="flex items-center gap-4 rounded py-3 px-6 bg-[#FF4D30] text-white shadow-custom hover:shadow-custom-hovered transition-all duration-300 ease-in-out w-48">
            <p>Find Details </p>{" "}
            <span>
              <FiArrowRightCircle />
            </span>
